...
class InitiateFlowNoInitialEmailRequest(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, doc_id_field, token_field, *args, **kwargs):  # noqa: E501
        """InitiateFlowNoInitialEmailRequest - a model defined in OpenAPI
