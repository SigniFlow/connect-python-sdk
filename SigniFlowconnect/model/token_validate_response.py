...
class TokenValidateResponse(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, result_field, token_field, *args, **kwargs):  # noqa: E501
        """TokenValidateResponse - a model defined in OpenAPI
