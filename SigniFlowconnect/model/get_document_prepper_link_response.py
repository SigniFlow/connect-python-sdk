...
class GetDocumentPrepperLinkResponse(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, result, url, *args, **kwargs):  # noqa: E501
        """GetDocumentPrepperLinkResponse - a model defined in OpenAPI
