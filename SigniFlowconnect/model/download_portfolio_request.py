...
class DownloadPortfolioRequest(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, portfolio_id_field, token_field, *args, **kwargs):  # noqa: E501
        """DownloadPortfolioRequest - a model defined in OpenAPI
